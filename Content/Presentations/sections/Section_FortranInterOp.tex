  ...
  \begin{itemize}
    ...
    \item Requirements:
      \begin{itemize}
        ...
        \item C\texttt{++}17/Fortran08 compiler suites
      \end{itemize}
    \item Configure\\
...
\begin{frame}{Kokkos::View}
  \begin{itemize}
    ...
    \item \texttt{Kokkos::View} can have up to 8 dimensions in C\texttt{++} but they are
...
! Kokkos View only accessible from C\texttt{++}
...
\begin{frame}{Kokkos::DualView}
  \begin{itemize}
    ...
    \item The synchronization must be done in C\texttt{++}
    \item Supported memory spaces: \texttt{Kokkos::HostSpace},
...
\begin{frame}{Kernel}
  \begin{itemize}
    \item Kernels using Kokkos are written in C\texttt{++}
    \item Use C-binding from Fortran standard 
    \item Create a subroutine that calls the C\texttt{++} function
  \end{itemize}
\end{frame}
