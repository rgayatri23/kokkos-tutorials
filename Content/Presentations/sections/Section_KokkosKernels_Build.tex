...
\item Keep builds simple. Language is always C\texttt{++} (even if CUDA, HIP, Sycl, ...) and all necessary flags are taken care of for you!
...
\uncover<2-> { \item Declare your C\texttt{++} project }
...
\begin{cmake}[linebackground={
  ...
  \btLstHL<5>{8-9}{orange!30}    
    ...
    project(myProject CXX) # C\texttt{++} needed to build my project
...
\uncover<3-> { \item Use the same C\texttt{++} complier as Kokkos }
